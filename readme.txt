...
Uses custom post types and taxonomies to manage an FAQ section on your WordPress site.

== Description ==

Uses custom post types and taxonomies to manage an FAQ section for your WordPress site. Includes a set of custom taxonomies to organize, and shortcode options for different display configurations.

== Installation ==

This section describes how to install the plugin and get it working.

1. Upload the 'faq-manager-wordpress’ folder to the `/wp-content/plugins/` directory or install via the WP admin panel
...
It uses the custom post type feature to create a dedicated FAQ section within your WordPress site, including categories and tags exclusive to them.
...
= 1.323 =
* minor bugfix for conflicts with certain commercial forms plugins
