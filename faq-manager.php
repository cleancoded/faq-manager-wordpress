<?php
/*
Plugin Name: FAQ Manager for WordPress 
Plugin URI: https://github.com/cleancoded/faq-manager-wordpress/
Description: Creates custom post types and taxonomies to manage an FAQ section within your WordPress site.
Author: CLEANCODED
Version: 1.331
Requires at least: 3.0
Author URI: https://cleancoded.com
*/
/*  Copyright 2017 CLEANCODED
		...
		<div id="side-info-column" class="inner-sidebar">
			<div class="meta-box-sortables">
				<div id="faq-admin-about" class="postbox">
					...
					<div class="inside">
						<p><?php _e('Talk to') ?> <a href="http://twitter.com/cleancoded" target="_blank">@cleancoded</a> <?php _e('on twitter or visit the', 'wpfaq'); ?> <a href="https://github.com/cleancoded/faq-manager-wordpress/issues" target="_blank"><?php _e('plugin support forum') ?></a> <?php _e('for bugs or feature requests.', 'wpfaq'); ?></p>
						<p><?php _e('<strong>Enjoy the plugin?</strong>', 'wpfaq'); ?><br />
						<a href="//twitter.com/?status=I'm using the FAQ Manager for WordPress plugin by @cleancoded - check it out! https://github.com/cleancoded/faq-manager-wordpress" target="_blank"><?php _e('Tweet about it', 'wpfaq'); ?></a> <?php _e('and consider contributing!', 'wpfaq'); ?></p>
						<p><?php _e('<strong>Visit Us:</strong> <a href="https://cleancoded.com/"', 'wpfaq'); ?></p>
					</div>
				</div>
			</div>
			...
			<div class="meta-box-sortables">
				<div id="faq-admin-more" class="postbox">
					...
					<div class="inside">
						<ul>
						<li><a href="https://github.com/cleancoded/FAQ-Manager-WordPress" target="_blank"><?php _e('Plugin on GitHub', 'wpfaq'); ?></a></li>
						<li><a href="https://github.com/cleancoded/FAQ-Manager-WordPress/issues/" target="_blank"><?php _e('Support Forum', 'wpfaq'); ?></a><li>
